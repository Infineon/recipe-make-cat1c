...
recipe_vscode_meta_data_file:
	$(call mtb__file_write,$(_MTB_RECIPE__VSCODE_TEMPLATE_META_DATA_FILE),)
...
ifneq (,$(_MTB_RECIPE__IS_FIRST_PRJ))
	...
	$(call mtb__file_append,$(_MTB_RECIPE__ECLIPSE_TEMPLATE_META_DATA_FILE),TEMPLATE_REPLACE=$(_MTB_RECIPE__IDE_RECIPE_DIR)/App/external=../.mtbLaunchConfigs)
else
...
ifeq ($(MTB_RECIPE__CORE_NAME),CM7_1)
	...
	$(call mtb__file_append,$(_MTB_RECIPE__ECLIPSE_TEMPLATE_META_DATA_FILE),TEMPLATE_REPLACE=$(_MTB_RECIPE__IDE_RECIPE_DIR)/Proj/single/external=.mtbLaunchConfigs)
