...
_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER=set QSPI_FLASHLOADER $(MTB_TOOLS__PRJ_DIR)/$(patsubst %/,%,$(CY_QSPI_FLM_DIR_OUTPUT))/CAT1C_SMIF.FLM
_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER_WITH_FLAG=-c &quot;$(_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER)&quot;&\#13;&\#10;
_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER_RELATIVE=$(patsubst $(call mtb_path_normalize,$(MTB_TOOLS__PRJ_DIR)/..)/%,%,$(_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER))
endif
...
eclipse_recipe_metadata_file:
	$(call mtb__file_append,$(_MTB_ECLIPSE_METADATA_FILE),RECIPE_TEMPLATE=$(_MTB_ECLIPSE_TEMPLATE_RECIPE_SEARCH))
	$(call mtb__file_append,$(_MTB_ECLIPSE_METADATA_FILE),RECIPE_APP_TEMPLATE=$(_MTB_ECLIPSE_TEMPLATE_RECIPE_APP_SEARCH))
	$(call mtb__file_append,$(_MTB_ECLIPSE_METADATA_FILE),PROJECT_UUID=&&PROJECT_UUID_$(MTB_RECIPE__CORE_NAME)&&)
endif
