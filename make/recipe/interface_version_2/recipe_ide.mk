...
ifeq (CM7,$(MTB_RECIPE__CORE))
	$(call mtb__file_append,$(_MTB_RECIPE__VSCODE_TEMPLATE_REGEX_DATA_FILE),^(.*)//CM7 Only//(.*)$$=\1\2)
else
	$(call mtb__file_append,$(_MTB_RECIPE__VSCODE_TEMPLATE_REGEX_DATA_FILE),^.*//CM7 Only//.*$$=)
endif
