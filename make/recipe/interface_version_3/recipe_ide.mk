...
ifneq (,$(_MTB_RECIPE__IS_MULTI_CORE_APPLICATION))
	$(call mtb__file_append,$(_MTB_RECIPE__VSCODE_TEMPLATE_META_DATA_FILE),TEMPLATE_REPLACE=$(MTB_TOOLS__CORE_DIR)/make/scripts/interface_version_3/vscode/dependencies_tasks.json=.vscode/tasks.json)
ifneq (,$(_MTB_RECIPE__IS_FIRST_PRJ))
	...
	$(call mtb__file_append,$(_MTB_RECIPE__VSCODE_TEMPLATE_META_DATA_FILE),TEMPLATE_REPLACE=$(MTB_TOOLS__CORE_DIR)/make/scripts/interface_version_3/vscode/tasks.json=../.vscode/tasks.json)
...
ifneq (,$(_MTB_RECIPE__IS_FIRST_PRJ))
	...
	$(call mtb__file_append,$(_MTB_RECIPE__ECLIPSE_TEMPLATE_META_DATA_FILE),TEMPLATE_REPLACE=$(MTB_TOOLS__RECIPE_DIR)/make/recipe/interface_version_3/App/$(_MTB_RECIPE__PROGRAM_INTERFACE_SUBDIR)/external=../.mtbLaunchConfigs)
else
...
ifeq ($(MTB_RECIPE__CORE_NAME),CM7_1)
	...
	$(call mtb__file_append,$(_MTB_RECIPE__ECLIPSE_TEMPLATE_META_DATA_FILE),TEMPLATE_REPLACE=$(MTB_TOOLS__RECIPE_DIR)/make/recipe/interface_version_3/Proj/$(_MTB_RECIPE__PROGRAM_INTERFACE_SUBDIR)/single/external=.mtbLaunchConfigs)
